...
**Último módulo completado:** 04-split-percent-mode
**Próximo módulo a ejecutar:** [prompts/05-fase-splits/05-split-amount-mode.md](../prompts/05-fase-splits/05-split-amount-mode.md)
