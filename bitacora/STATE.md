...
**Último módulo completado:** 02-split-ui-toggle
**Próximo módulo a ejecutar:** [prompts/05-fase-splits/03-split-equal-mode.md](../prompts/05-fase-splits/03-split-equal-mode.md)
