...
**Último módulo completado:** 03-split-equal-mode
**Próximo módulo a ejecutar:** [prompts/05-fase-splits/04-split-percent-mode.md](../prompts/05-fase-splits/04-split-percent-mode.md)
